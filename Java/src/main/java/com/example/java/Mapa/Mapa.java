...
import com.example.java.Objeto.*;
 ...
 * Cada nivel espec�fico debe ser definidio como una sub-clase de esta clase.
 */
public abstract class Mapa {
	...
	public void setEntidad(Torre n) {
	 ...
	 // Se a�ade un enemigo al mapa. Como los enemigos se mueven por el mapa,esta operaci�n tambi�n se utilizar para actualizar la celda que ocupa dentro del mapa.
    ...
    public void eliminarEntidad(DisparoAliado disparoAliado) {
    this.eliminarEntidad(disparoAliado);
	}

	public void eliminarEntidad(DisparoEnemigo j) {
	this.eliminarEntidad(j);
	}
}
